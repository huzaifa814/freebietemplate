...
const faqs = [
  ...
  { q: 'Why is this completely free?', a: 'A small banner ad on the page covers the hosting cost — that is the entire business model. There is no per-customer cost, so there is nothing to charge for. No subscriptions, no premium tier, no "sign up to download."' },
